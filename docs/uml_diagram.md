        ...
        <div class="lsm-grid l2">
          ...
          <div class="lsm-card lsm-basis">
            ...
            <div class="lsm-card-body">
              ...
              <div class="lsm-sig"><span class="lsm-name">MonomialBasis(int power)</span></div>
              <div class="lsm-sig"><span class="lsm-type">double</span> <span class="lsm-name">evaluate(double x)</span></div>
            </div>
            <div class="lsm-card-note">Returns x, x^2, x^3, ...</div>
          </div>
          ...
          <div class="lsm-card lsm-basis">
            ...
            <div class="lsm-card-body">
              ...
              <div class="lsm-sig"><span class="lsm-name">LaguerrePolynomial(int n)</span></div>
              <div class="lsm-sig"><span class="lsm-type">double</span> <span class="lsm-name">evaluate(double x)</span></div>
            </div>
          ...
          <div class="lsm-card lsm-proc">
            ...
            <div class="lsm-card-body">
              ...
              <div class="lsm-sig"><span class="lsm-name">GBM(double r, double sigma)</span></div>
            ...
            <div class="lsm-card-note">GBM: dS = rSdt + sigma SdW.</div>
          </div>
          ...
          <div class="lsm-card lsm-proc">
            ...
            <div class="lsm-card-body">
              ...
              <div class="lsm-sig"><span class="lsm-name">JDP(r, sigma, lambda)</span></div>
          ...
          <div class="lsm-card lsm-pay">
            ...
            <div class="lsm-card-body">
              <div class="lsm-sig"><span class="lsm-name">Put_payoff(double K)</span></div>
              <div class="lsm-sig"><span class="lsm-type">double</span> <span class="lsm-name">payoff(double S) const</span></div>
              <div class="lsm-sig"><span class="lsm-type">bool</span> <span class="lsm-name">InTheMoney(double S) const</span></div>
            </div>
          ...
          <div class="lsm-card lsm-pay">
            ...
            <div class="lsm-card-body">
              <div class="lsm-sig"><span class="lsm-name">Call_payoff(double K)</span></div>
              <div class="lsm-sig"><span class="lsm-type">double</span> <span class="lsm-name">payoff(double S) const</span></div>
              <div class="lsm-sig"><span class="lsm-type">bool</span> <span class="lsm-name">InTheMoney(double S) const</span></div>
            </div>
        ...
        <div class="lsm-grid l3">
          <div class="lsm-card lsm-util">
            ...
            <div class="lsm-card-body">
              ...
              <div class="lsm-sig"><span class="lsm-name">RNG(unsigned seed)</span></div>
          ...
          <div class="lsm-card lsm-util">
            ...
            <div class="lsm-card-note">ITM filter to design matrix to QR solve to continuation coefficients.</div>
          </div>
        ...
        <div class="lsm-grid l4">
          <div class="lsm-card lsm-eng">
            ...
            <div class="lsm-card-body">
              ...
              <div class="lsm-sig"><span class="lsm-name">LSMPricer(const StochasticProcess&amp;, const OptionPayoff&amp;, const BasisSet&amp;, const LSMConfig&amp;)</span></div>
            ...
            <div class="lsm-card-note">price() to simulatePaths() to backwardInduction() to OLS regression to computeOptionValue().</div>
          </div>
        </div>
      </section>
        ...
        <div class="lsm-grid l5">
          <div class="lsm-card lsm-eng">
            ...
            <div class="lsm-card-body">
              ...
              <div class="lsm-section-label">Public</div>
              <div class="lsm-sig"><span class="lsm-name">ConvergenceAnalyser(...)</span></div>
